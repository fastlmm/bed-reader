...
[<img alt="build status" src="https://github.com/fastlmm/bed-reader/actions/workflows/ci.yml/badge.svg?branch=master" height="20">](https://github.com/fastlmm/bed-reader/actions/workflows/ci.yml?query=branch%3Amaster)
