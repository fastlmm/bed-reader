...
ext_modules = [
    Extension(
        ...
        language="c++",
        sources=[
            "bed_reader/wrap_plink_parser_onep.pyx" if use_cython else "bed_reader/wrap_plink_parser_onep.cpp",
    ...
    Extension(
        ...
        language="c++",
        sources=[
            "bed_reader/wrap_matrix_subset.pyx" if use_cython else "bed_reader/wrap_matrix_subset.cpp",
...
if platform.system() != "Darwin":
    ext_modules.append(
        ...
        language="c++",
        sources=[
            "bed_reader/wrap_plink_parser_openmp.pyx" if use_cython else "bed_reader/wrap_plink_parser_openmp.cpp",
            "bed_reader/CPlinkBedFile.cpp",
        ],
        libraries = [mp5lib],
